...
public class SavePurchase {
	...
	public Purchase savePurchase(PurchaseCommand purchaseCommand) {
		return purchaseRepository.save(new Purchase(purchaseCommand.getId(),purchaseCommand.getChair(),purchaseCommand.getIdClient(),purchaseCommand.getPurchaseTime(),purchaseCommand.getPurchaseDay(),purchaseCommand.getTotal()));
	}	
}
